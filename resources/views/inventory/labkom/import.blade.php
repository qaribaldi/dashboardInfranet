...
@section('content')
  <h2 class="text-2xl font-bold mb-4">Import CSV - Inventory Labkom</h2>

  <div class="mb-4">
    <a href="{{ route('inventory.labkom.template') }}"
  ...
  <form action="{{ route('inventory.labkom.importStore') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
    @csrf
    ...
    <div class="pt-2 flex items-center gap-3">
      ...
      <a href="{{ route('inventory.labkom.index') }}" class="rounded-lg border px-4 py-2 hover:bg-gray-50">Kembali</a>
    </div>
  </form>
@endsection
