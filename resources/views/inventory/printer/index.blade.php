...
@section('content')
  ...
  <div class="bg-white rounded-xl border border-gray-200 overflow-x-auto">
    @php
      ...
      // Ambil semua kolom dari tabel printer
      $cols = Schema::getColumnListing('asset_printer');

      // Sembunyikan kolom tertentu (atur sesuai kebutuhan)
      ...
      // Hitung total kolom untuk baris kosong
    ...
    @if(auth()->user()->role === 'admin')
      <div id="addColModal" class="fixed inset-0 hidden items-center justify-center z-[70]">
        ...
        <div class="relative bg-white rounded-xl shadow-xl w-[95vw] max-w-md">
          ...
          <form method="POST" action="{{ route('inventory.printer.columns.add') }}" class="p-4 space-y-3">
            @csrf
            <div>
