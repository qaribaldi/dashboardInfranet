...
@section('content')
  <div class="flex items-center justify-between mb-6">
    ...
    <div class="flex gap-2">
      <a href="{{ route('pc.edit',$data->id_pc) }}" class="rounded border px-4 py-2 hover:bg-gray-50">Edit</a>
      <a href="{{ route('pc.index') }}" class="rounded border px-4 py-2 hover:bg-gray-50">Kembali</a>
    </div>
  </div>
