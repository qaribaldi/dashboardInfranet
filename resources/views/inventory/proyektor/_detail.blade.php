@php
    ...
    // Susun kolom standar Proyektor (silakan sesuaikan jika perlu)
    $std = [
        'id_proyektor','ruang','nama_ruang','merk', 'tipe_proyektor',
        'resolusi_max','vga_support','hdmi_support','kabel_hdmi', 'remote','tahun_pembelian', 'keterangan_tambahan',
    ];

    // Ambil semua kolom nyata dari tabel
    $allCols = array_values(array_diff(
        Schema::getColumnListing('asset_proyektor'),
...
<div class="space-y-4">
  ...
  @unless(request('readonly') == '1')
    <div class="flex justify-end gap-2">
      ...
      <form action="{{ route('inventory.proyektor.destroy', $data->id_proyektor) }}"
