...
@endforeach
    ...
    @if($mode === 'edit')
      <div>
        ...
        <textarea id="catatan_histori" name="catatan_histori" 
                  class="w-full rounded-lg border border-gray-300 px-3 py-2" 
                  rows="3" 
                  placeholder="Misal: Ganti remote, servis kompresor, tambah freon, dll.">{{ old('catatan_histori') }}</textarea>
      </div>
    @endif
    ...
    <div class="flex items-center gap-3">
      ...
      <a href="{{ route('inventory.ac.index') }}" class="rounded-lg border px-4 py-2 hover:bg-gray-50">Batal</a>
    </div>
  </form>
@endsection
